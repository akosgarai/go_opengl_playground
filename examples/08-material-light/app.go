...
func main() {
	...
	shaderProgramColored := shader.NewShader("examples/08-material-light/vertexshader.vert", "examples/08-material-light/fragmentshader.frag")
	...
	shaderProgramWhite := shader.NewShader("examples/08-material-light/vertexshader.vert", "examples/08-material-light/fragmentshader.frag")
