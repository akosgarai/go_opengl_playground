...
func main() {
	...
	form.AddFormItemInt("Int 04.", glWrapper, "0")
	form.AddFormItemInt("Int 05.", glWrapper, "12")
	form.AddFormItemInt("Int 06.", glWrapper, "-3")
	form.AddFormItemBool("Bool 07.", glWrapper, true)
	form.AddFormItemFloat("Float 08.", glWrapper, "0.0")
	form.AddFormItemFloat("Float 09.", glWrapper, "1.876")
	form.AddFormItemFloat("Float 10.", glWrapper, "-0.44")
	form.AddFormItemText("Text 11.", glWrapper, "Some")
	form.AddFormItemText("Text 12.", glWrapper, "sample")
	form.AddFormItemText("Text 13.", glWrapper, "text")
	form.AddFormItemInt64("Int64 14.", glWrapper, "0")
	form.AddFormItemInt64("Int64 15.", glWrapper, "1231234")
	form.AddFormItemInt64("Int64 16.", glWrapper, "-1239876")
